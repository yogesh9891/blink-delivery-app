...
const styles = StyleSheet.create({
    ...
    reletiproname: {
        fontFamily:'DMSans-Medium', fontSize: 12, color: '#000', marginBottom: 5, marginTop: 5
    },
    reletiprodgram: {
        color: '#959494',  fontFamily:'DMSans-Medium',fontSize: 12, marginBottom: 5
    },
    reletiprodprice: {
        color: '#000', fontSize: 14,  fontFamily:'DMSans-Medium',
    },
    addproductbtn: {
        color: '#fff',
        fontFamily:'DMSans-Medium',

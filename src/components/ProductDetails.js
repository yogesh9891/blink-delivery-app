...
export default function ProductDetails(props) {
  ...
  console.log(JSON.stringify(props, null, 2), "props from products")
      ...
      <ScrollView style={styles1.bgcolorwhite}>
        <View style={ExternalStyles.pdlr}>
          <Swiper
            ...
            <View style={[ExternalStyles.slide1, ExternalStyles.textcenter]}>
              <Image source={require('../../assets/img/product1.png')} />
            </View>
            <View style={[ExternalStyles.slide2, ExternalStyles.textcenter]}>
              <Image source={require('../../assets/img/product1.png')} />
            </View>
            <View style={[ExternalStyles.slide3, ExternalStyles.textcenter]}>
              <Image source={require('../../assets/img/product1.png')} />
            </View>
            <View style={[ExternalStyles.slide4, ExternalStyles.textcenter]}>
              <Image source={require('../../assets/img/product1.png')} />
            </View>
          </Swiper>
          <View style={ExternalStyles.mttop10}>
            <View style={ExternalStyles.prodcoff}>
              <View>
                ...
                <Text
                  style={{ color: '#303733', fontWeight: '400', fontSize: 12 }}>
                  12pc
                </Text>
              </View>
              <View>
            ...
            <View style={[ExternalStyles.adprice, ExternalStyles.rowflex1, ExternalStyles.mttop10]}>
              <View>
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                  <Text
                    ...
                    <FontAwesome name={'inr'} size={20} color={'#000'} /> 40
                  </Text>
                  <Text
                    style={{
                      color: '#959494',
              ...
              <View>
                {addtoggle == false ? (
                  <TouchableOpacity onPress={() => setaddToggle(true)}>
                    <LinearGradient
                      start={{ x: 0.0, y: 0.0 }}
                      end={{ x: 1.0, y: 0.0 }}
                      colors={disableAddBtn ? ['#959494', '#959494'] : ['#F03893', '#F7A149']}
                      style={ExternalStyles.addbtn}>
                      <Text
                        style={[
                          ExternalStyles.btntext,
                    ...
                    <View style={[styles.flexRow, { marginTop: 15 }]}>
                      {
                        plansArr.map((el, index) => {
                          return (
                            <Pressable onPress={() => { setSelectedtype(el.name); setPlanSelectEnabled(false) }} style={{ flex: index != 1 ? 1 : 1.5, borderRadius: 7,  marginHorizontal: 7, display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "white" }} key={index}>
          ...
          <View style={ExternalStyles.decriptbox}>
            <View style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              <Entypo
                name={!toggle ? 'chevron-down' : 'chevron-up'}
                size={20}
                color={'#000'}
                style={{ textAlign: 'right' }}
              />
            </View>
            <Text style={[ExternalStyles.prductdecrp, ExternalStyles.mttop5]}>
              Banana serves as an ideal and low cost food source...
            </Text>
            {toggle && (
              <Text style={ExternalStyles.prductdecrp}>
                Banana serves as an ideal and low cost food source for
                developing countries where most of the population rely mostly on
                bananas for food. Banana plant parts are useful as insecticide,
                antioxidant, colour absorber, in preparation of various
                functional foods, wine, alcohol, biogas, cattle feed etc. This
                review discusses usefulness of banana fruits, peel, leaves,
                pseudostem, sheath, pith and male bud, and prospects of using
        ...
        <View style={ExternalStyles.pdlr}>
          <View style={ExternalStyles.viewcartbotm}>
            <View style={[ExternalStyles.rowflex1, ExternalStyles.botomvewcart]}>
              <View>
                <Text style={ExternalStyles.itemselectxt}>2 items</Text>
                <Text style={ExternalStyles.viewcartprc}>
                  <FontAwesome name={'inr'} size={19} color={'#fff'} /> 70
                </Text>
              </View>

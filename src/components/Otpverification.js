...
export default function Otpverification(props) {
    ...
    const verifyOtp = async () => {
      ...
      try {
        ...
        console.log(response, 'CONSOINGLICONSOINGLICONSOINGLICONSOINGLICONSOINGLI');
            
            if (response?.success) {
              setIsAuthorised(true);
              console.log("CONSOINGLI")
        ...
        <>
            ...
            <View style={[styles.bgbodycolor, styles.flexbodycolorone, styles.prletive]}>
                ...
                <View style={styles.logoabsl}>
                    {/* <Image source={require('../../assets/img/logo.png')}  style={styles.logocenter}/> */}
                </View>
                <View style={[styles.pdlr, styles.otpsection]}>
                    <Text style={styles.texttop}> OTP </Text>
                    <Text style={styles.texttop}> Verification </Text>
                    <Text style={{fontFamily:'DMSans-Regular',fontSize:16,color:'#14131280'}}>OTP has been sent to +91 {mobileNum}</Text>
                    <Text style={{ textAlign: 'right', color: '#000', fontWeight: '600', marginTop: 25, marginBottom: 10 }}>02:30</Text>
            ...
            />
                    ...
                    <Pressable onPress={() => verifyOtp()}>
                        <LinearGradient start={{ x: 0.0, y: 0.0 }} end={{ x: 1.0, y: 0.0 }} colors={['#F03893', '#F7A149']} style={[styles.subbtn, styles.mttop10]}>
                            <Text style={[styles.textwhite, styles.textcenter]}>Verify</Text>
                        </LinearGradient>
                    </Pressable>
                    <Pressable onPress={()=>resendOtp()} style={styles.mttop10}>
